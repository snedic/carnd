...
As a first step, I decided to convert the images to grayscale because of the visualization outputs I received in the previous section.  I noticed the grayscale eliminated much of the apparante noise caused by having the RGB channels. 

Above are a couple examples of a traffic signs image before and after grayscaling (& thresholding).

As a last step, I normalized the image data in order to improve performance.  I noticed a decent improvement in the model training after I normalized the data.

I decided to generate additional data because I thought ultimately more data would give the NN more options for separating the data into the classes.  Ultimately I found the grayscale to be the dominate dataset. 

To add more data to the the data set, I added the grayscale as a fourth channel.  

Here is an example of an original image and an augmented image:

![alt text][sign3]

The difference between the original data set and the augmented data set is that one dataset I created is strictly grayscale, and another is RGB + Grayscale.  
